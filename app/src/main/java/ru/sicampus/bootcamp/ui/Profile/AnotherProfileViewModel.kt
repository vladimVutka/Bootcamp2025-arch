...
import ru.sicampus.bootcamp.domain.list.GetAnotherProfileUseCase
import ru.sicampus.bootcamp.domain.list.ProfileEntity

class AnotherProfileViewModel(
    private val getUsersUseCase: GetAnotherProfileUseCase
) : ViewModel() {
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(modelClass: Class<T>): T {
                return AnotherProfileViewModel(
                    getUsersUseCase = GetAnotherProfileUseCase(
